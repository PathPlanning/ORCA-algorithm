...
void ORCAAgent::computeNewControl()
{
    ORCALines.clear();
//	std::cout << std::endl;
//	std::cout << "agents_max_num = " << param.agentsMaxNum << std::endl;
//	std::cout << "agent_size = " << fakeRadius << std::endl;
//	std::cout << "time_boundary = " << param.timeBoundary << std::endl;
//	std::cout << "time_step = " << options->timestep << std::endl;
//	std::cout << "responsibility_factor = " << 0.5 << std::endl;
...
//	std::cout << "agent_state = np.array([" << position.X() << ", " << position.Y() << ", 0.0, " << currV.X() << ", " << currV.Y() << "])" << std::endl;
//	std::cout << "neighbors_states = np.array([\n";
...
//		std::cout << "[" << curragent->position.X() << ", " << curragent->position.Y() << ", " << curragent->currV.X() << ", " << curragent->currV.Y() << "]," << std::endl;
...
//	std::cout << "]).reshape((" << ORCALines.size() << ", 4))" << std::endl;

//	std::cout << "lines = np.array([\n";
//	for (int i = numObstLines; i < ORCALines.size(); i++)
//	{
//		std::cout << "[" << ORCALines[i].dir.X() << ", " << ORCALines[i].dir.Y() << ", " << ORCALines[i].liesOn.X() << ", " << ORCALines[i].liesOn.Y() << "],\n";
//	}
//	std::cout << "]).reshape((" << ORCALines.size() << ", 4))" << std::endl;
...
void ORCAAgent::applyNewControl()
{
    currV = newV;
}


bool ORCAAgent::prepareBeforeStep()
{
    Point next;
