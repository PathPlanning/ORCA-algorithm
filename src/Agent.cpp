...
void Agent::addNeighbour(Agent &neighbour, float dist_sq)
{
...
void Agent::updatePosition(const Point &pos)
{
    position = pos;
}
...
void Agent::updateObstacleInformation()
{
...
std::pair<unsigned int, unsigned int> Agent::getCollisionCount() const
{
...
Point Agent::getNextGoalPoint() const
{
    return nextForLog;
}
