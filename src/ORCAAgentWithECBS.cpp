...
void ORCAAgentWithECBS::computeNewControl()
{
    if(MAPFExec)
    {
        // Collision count
...
void ORCAAgentWithECBS::applyNewControl()
{
    MAPFVis = false;
    notMAPFVis = false;
    MAPFUnion = false;
...
bool ORCAAgentWithECBS::prepareBeforeStep()
{
    Point next;
    if(inMAPFMode)
    {
...
void ORCAAgentWithECBS::addNeighbour(Agent &neighbour, float dist_sq)
{
