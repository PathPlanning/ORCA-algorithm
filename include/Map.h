...
class Map
{
    public:
        ...
        std::vector<ObstacleSegment> GetCloseObstacles(const Point &point, float spacing) const;
    ...
    private:
        ...
        unsigned int height;
        unsigned int width;
        std::vector<std::vector<int>> *grid;  // TODO Change to smart pointer and make it updatable
